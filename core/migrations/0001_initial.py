# Generated by Django 5.0.3 on 2024-03-09 20:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retal_price_day', models.DecimalField(blank=True, decimal_places=1, max_digits=5, null=True)),
                ('retal_period', models.IntegerField(blank=True, null=True)),
                ('active', models.BooleanField(default=True)),
                ('status', models.CharField(blank=True, choices=[('متاح', 'متاح'), ('مستاجر', 'مستاجر'), ('مباع', 'مباع')], max_length=50, null=True)),
